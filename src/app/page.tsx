...
import { ExternalLink, Facebook, MessageCircle, RefreshCcw, Phone as WhatsApp } from 'lucide-react';
        ...
        <div className="w-full max-w-7xl mx-auto mt-16 rounded-4xl py-12 relative overflow-hidden bg-slate-900 flex items-center">
          ...
          <div className="max-w-7xl px-10 w-full relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="w-16 h-16 bg-white/10 backdrop-blur-md rounded-lg flex items-center justify-center overflow-hidden shadow-2xl">
                <Image src="/gallery/stackrover.png" alt="StackRover Logo" width={500} height={500} className="object-contain h-full w-full" />
              </div>
        ...
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button
              ...
              asChild
            >
              <Link prefetch={false} href="https://wa.me/8801714834109" target="_blank" rel="noreferrer">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative overflow-hidden rounded-[2.5rem] bg-slate-900 border border-slate-800 shadow-2xl group">
            ...
            <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center gap-10">
              ...
              <div className="relative w-48 h-48 md:w-64 md:h-64 flex items-center justify-center overflow-hidden rounded-2xl">
                <Image src="/gallery/stackrover.png" alt="StackRover Logo" width={500} height={500} className="object-contain h-full w-full" />
              </div>
            </div>
          </div>
